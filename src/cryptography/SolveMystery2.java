...
public class SolveMystery2 {
    ...
    public static final String BIGRAM_FILE_NAME = "spanish_bigram";
    public static final String MYSTERY_FILE_NAME = "mystery";

    public static void main(String args[]) {
        totalCharCount = setBiFrequencyProfile();
    ...
    public static int setBiFrequencyProfile() {
            ...
            while((line = bufferedReader.readLine()) != null) {
                ...
                if(line.length()>5){
                    for(int i = 0; i < line.length()-1; i++) {
                        String letters = line.substring(i,i+2);
                        addBilettersToFrequencyArray(showtimes,letters);
                        totalCharCount++;
                    }
                }
            }
    ...
    public static void addBilettersToFrequencyArray(String[][] showtimes, String bi) {
        int i;
...
class BiCharFrequency implements Comparable<BiCharFrequency> {
    ...
    public BiCharFrequency(String letters, double frequency) {
